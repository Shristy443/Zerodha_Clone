    ...
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          ...
          <p className="text-small text-muted">Thematic investment platform that helps you invest you invest in deversified baskets of stocks on ETFs.</p>
        </div>
        <div className="col-4 p-3 mt-5">
        ...
        <div className="col-4 p-3 mt-5">
          ...
          style={{ width: "60%", height: "30%" }} />
          <p className="text-small text-muted">Systematic trading platform that allows you to create and backtest strategues without coding.</p>
        </div>
        <div className="col-4 p-3 mt-5">
